...
public class GummyMouseOuterModel<T extends GummyMouseEntity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(CandyCraft.MODID, "gummy_mouse_outer"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = root.addOrReplaceChild("body",
            CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 3.0F, 6.0F),
            PartPose.offset(0.0F, 21.0F, -3.0F));
        PartDefinition head = body.addOrReplaceChild("head",
            CubeListBuilder.create().texOffs(0, 9).addBox(-1.5F, 0.0F, -3.0F, 3.0F, 2.0F, 3.0F),
        ...
        body.addOrReplaceChild("tail",
            CubeListBuilder.create().texOffs(0, 14).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 6.0F),
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        body.y = 21.0F;
        tail.yRot = Mth.sin(ageInTicks * 0.6F) * (float)Math.PI * 0.04F;
    }
