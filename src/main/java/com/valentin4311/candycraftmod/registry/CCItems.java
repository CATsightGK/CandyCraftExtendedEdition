...
public final class CCItems {
    ...
    public static final RegistryObject<Item> SUGAR_CRYSTAL = registerPortItem("sugar_crystal");
    ...
    public static final RegistryObject<Item> JELLY_KEY = registerPortItem("jelly_key");
