...
{
    private static readonly string[] ResourceNames = { "node.exe", "server.js", "index.html", "style.css", "app.js" };
    ...
    private static void Main()
    {
        ...
        Process.Start(new ProcessStartInfo
        {
            ...
            Arguments = Environment.GetEnvironmentVariable("CANDYCRAFT_NO_BROWSER") == "1"
                ? "server.js --no-browser"
                : "server.js",
